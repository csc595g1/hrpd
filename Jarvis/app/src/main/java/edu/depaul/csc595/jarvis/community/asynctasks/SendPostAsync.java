 ...
 */
public class SendPostAsync extends AsyncTask<Object,Void,Void>{
    private final String TAG = "SendReplyAsync";
    private CommunityPostMainModel model;
    private JSONObject outjson;
    private final String urlString = "https://jarvis-services.herokuapp.com/services/community/post";
    protected void onPreExecute(){
        super.onPreExecute();
    }

    protected Void doInBackground(Object... params) {
        if(params[0] instanceof CommunityPostMainModel){
            model = (CommunityPostMainModel)params[0];
        }

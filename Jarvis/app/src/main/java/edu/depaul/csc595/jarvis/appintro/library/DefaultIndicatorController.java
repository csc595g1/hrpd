...
class DefaultIndicatorController implements IndicatorController {
    ...
    public View newInstance(@NonNull Context context) {
        mContext = context;
        mDotLayout = (LinearLayout) View.inflate(context, R.layout.for_app_intro_default_indicator, null);
        return mDotLayout;
    }
    ...
    public void initialize(int slideCount) {
        ...
        for (int i = 0; i < slideCount; i++) {
            ...
            dot.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.for_app_intro_indicator_dot_grey));
    ...
    public void selectPosition(int index) {
        ...
        for (int i = 0; i < mSlideCount; i++) {
            int drawableId = (i == index) ? (R.drawable.for_app_intro_indicator_dot_white) : (R.drawable.for_app_intro_indicator_dot_grey);
